...
<body>
	<div class="container">
		...
		<input class="form-control form-control-sm" type="text" name="tvital" id="tvital" style="display:inline-block; width:300px;margin-top:25px;""><br />
		<label>Enter Heart Rate:</label>
		<input class="form-control form-control-sm" type="text" name="hvital" id="hvital" style="display:inline-block; width:300px;margin-top:25px;""><br />
	...
	<script>
		...
		function sendVitals()
		{
			...
			{
				var oxy=vital.value;
				var temp=tvital.value;
				var hrate=hvital.value;
				websocket.send(oxy+','+temp+','+hrate);
				vital.value="";
				tvital.value="";
				hvital.value="";
			}
				...
				{
				alert("You are perfectly alright. Stay happy and healthy..!!!");
				vital.value="";
				tvital.value="";
				hvital.value="";
				}
